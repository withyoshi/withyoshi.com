    ...
    <div className="grid grid-cols-1 md:grid-cols-[auto_auto] md:gap-6 lg:grid-cols-[32%_34%_auto] xl:grid-cols-[auto_25%_auto_auto]">
      ...
      >
        <ul>
          ...
          <li>
            Added style customization panels to 10+ Jetpack blocks, created the
            PocketCasts block, and converted 20+ legacy shortcodes into blocks.
          </li>
        </ul>
      </TimelineItem>
      ...
      >
        ...
        <ul>
          ...
          <li>
            Semantic search tool to quickly search through anything in the data
            lake.
          </li>
          <li>
      ...
      >
        <p>
          ...
          system, photo sharing & tagging, geolocation tagging, link discovery,
          activity streams, and privacy control.
        </p>
        <p>
